...
(assert (=> (= rf_3 2) (< ts_2 ts_3)))
(assert (=> (= rf_4 0) (< ts_init_x ts_4)))
(assert (=> (= rf_4 1) (< ts_1 ts_4)))
(assert (< ts_init_x ts_1))
(assert (< ts_init_y ts_0))
(assert (< ts_init_y ts_2))
(assert (=> co_y_1_2 (< ts_0 ts_2)))
(assert (=> co_y_2_1 (< ts_2 ts_0)))
(assert (=> (= rf_3 0) (< ts_3 ts_0)))
(assert (=> (= rf_3 0) (< ts_3 ts_2)))
(assert (=> (and (= rf_3 1) co_y_1_2) (< ts_3 ts_2)))
(assert (=> (and (= rf_3 2) co_y_2_1) (< ts_3 ts_0)))
(assert (=> (= rf_4 0) (< ts_4 ts_1)))
(assert (and (or (= rf_3 2)) (or (= rf_4 0))))

(check-sat)

; ── UNSAT Proof Certificate ──
; Status: UNSAT — forbidden outcome UNREACHABLE under TSO
; Unsat core size: 5 assertions (out of 38)
; Core assertions: track_36, track_20, track_24, track_forbidden, track_21
(get-unsat-core)
