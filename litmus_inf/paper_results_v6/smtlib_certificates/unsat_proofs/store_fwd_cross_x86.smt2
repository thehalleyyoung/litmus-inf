...
(assert (and (or (= rf_2 1)) (or (= rf_3 1)) (or (= rf_4 0))))

(check-sat)

; ── UNSAT Proof Certificate ──
; Status: UNSAT — forbidden outcome UNREACHABLE under TSO
; Unsat core size: 5 assertions (out of 33)
; Core assertions: track_31, track_forbidden, track_20, track_18, track_24
(get-unsat-core)
