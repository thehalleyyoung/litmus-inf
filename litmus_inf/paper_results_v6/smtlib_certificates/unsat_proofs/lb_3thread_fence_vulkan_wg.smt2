...
; Pattern: lb_3thread_fence
; Forbidden outcome: {"r0": 1, "r1": 1, "r2": 1}
; ═══════════════════════════════════════════════════════════════════
...
(assert (=> (= rf_0 1) (< ts_8 ts_0)))
(assert (=> (= rf_3 0) (< ts_init_y ts_3)))
(assert (=> (= rf_3 1) (< ts_2 ts_3)))
(assert (=> (= rf_6 0) (< ts_init_z ts_6)))
(assert (=> (= rf_6 1) (< ts_5 ts_6)))
(assert (< ts_init_x ts_8))
(assert (< ts_init_y ts_2))
(assert (< ts_init_z ts_5))
(assert (=> (= rf_0 0) (< ts_0 ts_8)))
(assert (=> (= rf_3 0) (< ts_3 ts_2)))
(assert (=> (= rf_6 0) (< ts_6 ts_5)))
(assert (and (or (= rf_0 1)) (or (= rf_3 1)) (or (= rf_6 1))))
...
; Core assertions: track_31, track_27, track_35, track_28, track_29, track_forbidden, track_33
(get-unsat-core)
