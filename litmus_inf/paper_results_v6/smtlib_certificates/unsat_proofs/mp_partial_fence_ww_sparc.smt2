...
(assert (and (or (= rf_3 1)) (or (= rf_4 0))))

(check-sat)

; ── UNSAT Proof Certificate ──
; Status: UNSAT — forbidden outcome UNREACHABLE under PSO
; Unsat core size: 5 assertions (out of 27)
; Core assertions: track_19, track_forbidden, track_16, track_25, track_17
(get-unsat-core)
