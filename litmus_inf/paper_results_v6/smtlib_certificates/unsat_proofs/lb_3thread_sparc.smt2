...
(assert (and (or (= rf_0 1)) (or (= rf_2 1)) (or (= rf_4 1))))

(check-sat)

; ── UNSAT Proof Certificate ──
; Status: UNSAT — forbidden outcome UNREACHABLE under PSO
; Unsat core size: 7 assertions (out of 37)
; Core assertions: track_21, track_23, track_forbidden, track_29, track_22, track_27, track_25
(get-unsat-core)
