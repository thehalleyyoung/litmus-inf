...
(assert (=> (= rf_2 2) (< ts_5 ts_2)))
(assert (=> (= rf_4 0) (< ts_init_y ts_4)))
(assert (=> (= rf_4 1) (< ts_3 ts_4)))
(assert (=> (= rf_4 2) (< ts_5 ts_4)))
(assert (=> (= rf_7 0) (< ts_init_x ts_7)))
(assert (=> (= rf_7 1) (< ts_0 ts_7)))
(assert (< ts_init_x ts_0))
(assert (< ts_init_y ts_3))
(assert (< ts_init_y ts_5))
(assert (=> co_y_1_2 (< ts_3 ts_5)))
(assert (=> co_y_2_1 (< ts_5 ts_3)))
(assert (=> (= rf_2 0) (< ts_2 ts_3)))
(assert (=> (= rf_2 0) (< ts_2 ts_5)))
(assert (=> (and (= rf_2 1) co_y_1_2) (< ts_2 ts_5)))
(assert (=> (and (= rf_2 2) co_y_2_1) (< ts_2 ts_3)))
(assert (=> (= rf_4 0) (< ts_4 ts_3)))
(assert (=> (= rf_4 0) (< ts_4 ts_5)))
(assert (=> (and (= rf_4 1) co_y_1_2) (< ts_4 ts_5)))
(assert (=> (and (= rf_4 2) co_y_2_1) (< ts_4 ts_3)))
(assert (=> (= rf_7 0) (< ts_7 ts_0)))
(assert (and (or (= rf_4 1)) (or (= rf_7 0))))

(check-sat)

; ── UNSAT Proof Certificate ──
; Status: UNSAT — forbidden outcome UNREACHABLE under Vulkan-WG
; Unsat core size: 7 assertions (out of 55)
; Core assertions: track_29, track_53, track_36, track_forbidden, track_31, track_28, track_26
(get-unsat-core)
