...
(assert (and (or (= rf_2 2)) (or (= rf_3 1))))

(check-sat)

; ── UNSAT Proof Certificate ──
; Status: UNSAT — forbidden outcome UNREACHABLE under Vulkan-WG
; Unsat core size: 7 assertions (out of 36)
; Core assertions: track_19, track_forbidden, track_4, track_26, track_33, track_16, track_15
(get-unsat-core)
