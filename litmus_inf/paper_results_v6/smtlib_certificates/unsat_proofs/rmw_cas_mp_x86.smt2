...
(assert (=> (= rf_1 0) (< ts_1 ts_4)))
(assert (=> (and (= rf_1 1) co_y_1_2) (< ts_1 ts_4)))
(assert (=> (and (= rf_1 2) co_y_2_1) (< ts_1 ts_2)))
(assert (=> (= rf_3 0) (< ts_3 ts_2)))
(assert (=> (= rf_3 0) (< ts_3 ts_4)))
(assert (=> (and (= rf_3 1) co_y_1_2) (< ts_3 ts_4)))
(assert (=> (and (= rf_3 2) co_y_2_1) (< ts_3 ts_2)))
...
; Unsat core size: 5 assertions (out of 49)
; Core assertions: track_25, track_30, track_forbidden, track_22, track_47
(get-unsat-core)
