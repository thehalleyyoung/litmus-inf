...
;   e1: T1 Store y = 1
;   e2: T2 Load x → r0
;   e3: T2 Fence [scope=device]
;   e4: T2 Load y → r1
;   e5: T3 Load y → r2
;   e6: T3 Fence [scope=device]
;   e7: T3 Load x → r3
...
; Core assertions: track_41, track_33, track_27, track_26, track_39, track_forbidden, track_29
(get-unsat-core)
