...
(assert (and (or (= rf_1 1)) (or (= rf_3 1)) (or (= rf_4 0))))

(check-sat)

; ── UNSAT Proof Certificate ──
; Status: UNSAT — forbidden outcome UNREACHABLE under PSO
; Unsat core size: 6 assertions (out of 32)
; Core assertions: track_19, track_21, track_forbidden, track_30, track_23, track_18
(get-unsat-core)
