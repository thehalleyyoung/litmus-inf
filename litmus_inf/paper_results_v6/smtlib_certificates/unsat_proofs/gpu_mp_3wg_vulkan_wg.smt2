...
; Operations:
;   e0: T0 Store x = 1
;   e1: T0 Fence [scope=device]
;   e2: T0 Store y = 1
;   e3: T1 Load y → r0
;   e4: T1 Fence [scope=device]
;   e5: T1 Store z = 1
;   e6: T2 Load z → r1
;   e7: T2 Fence [scope=device]
;   e8: T2 Load x → r2
...
(assert (and (or (= rf_3 1)) (or (= rf_6 1)) (or (= rf_8 0))))
...
; Core assertions: track_33, track_41, track_forbidden, track_27, track_31, track_28, track_29
(get-unsat-core)
