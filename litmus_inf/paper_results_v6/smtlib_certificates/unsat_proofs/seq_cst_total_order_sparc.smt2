...
(assert (and (or (= rf_2 1)) (or (= rf_3 0)) (or (= rf_4 1)) (or (= rf_5 0))))

(check-sat)

; ── UNSAT Proof Certificate ──
; Status: UNSAT — forbidden outcome UNREACHABLE under PSO
; Unsat core size: 7 assertions (out of 39)
; Core assertions: track_35, track_29, track_forbidden, track_23, track_22, track_25, track_37
(get-unsat-core)
