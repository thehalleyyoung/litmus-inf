...
(assert (=> (= rf_1 2) (< ts_3 ts_1)))
(assert (=> (= rf_4 0) (< ts_init_y ts_4)))
(assert (=> (= rf_4 1) (< ts_2 ts_4)))
...
(assert (=> (and (= rf_1 1) co_y_1_2) (< ts_1 ts_3)))
(assert (=> (and (= rf_1 2) co_y_2_1) (< ts_1 ts_2)))
(assert (=> (= rf_4 0) (< ts_4 ts_2)))
(assert (=> (= rf_4 0) (< ts_4 ts_3)))
(assert (=> (and (= rf_4 1) co_y_1_2) (< ts_4 ts_3)))
(assert (=> (and (= rf_4 2) co_y_2_1) (< ts_4 ts_2)))
(assert (=> (= rf_5 0) (< ts_5 ts_0)))
(assert (and (or (= rf_1 0)) (or (= rf_5 0))))
