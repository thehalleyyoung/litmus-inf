...
(declare-fun co_x_3_1 () Bool)
(declare-fun co_x_1_3 () Bool)
(declare-fun co_x_3_2 () Bool)
(declare-fun co_x_2_3 () Bool)
...
(assert (or co_x_1_3 co_x_3_1))
(assert (not (and co_x_1_3 co_x_3_1)))
(assert (or co_x_2_3 co_x_3_2))
(assert (not (and co_x_2_3 co_x_3_2)))
(assert (=> (and co_x_1_2 co_x_2_3) co_x_1_3))
(assert (=> (and co_x_1_3 co_x_3_2) co_x_1_2))
(assert (=> (and co_x_2_1 co_x_1_3) co_x_2_3))
(assert (=> (and co_x_2_3 co_x_3_1) co_x_2_1))
(assert (=> (and co_x_3_1 co_x_1_2) co_x_3_2))
(assert (=> (and co_x_3_2 co_x_2_1) co_x_3_1))
(assert (>= ts_0 0))
(assert (< ts_0 50))
(assert (>= ts_1 0))
(assert (< ts_1 50))
...
(assert (=> (= rf_3 3) (< ts_2 ts_3)))
(assert (< ts_init_x ts_0))
(assert (< ts_init_x ts_1))
(assert (< ts_init_x ts_2))
(assert (=> co_x_1_2 (< ts_0 ts_1)))
(assert (=> co_x_1_3 (< ts_0 ts_2)))
(assert (=> co_x_2_1 (< ts_1 ts_0)))
(assert (=> co_x_2_3 (< ts_1 ts_2)))
(assert (=> co_x_3_1 (< ts_2 ts_0)))
(assert (=> co_x_3_2 (< ts_2 ts_1)))
(assert (=> (= rf_3 0) (< ts_3 ts_0)))
(assert (=> (= rf_3 0) (< ts_3 ts_1)))
(assert (=> (= rf_3 0) (< ts_3 ts_2)))
(assert (=> (and (= rf_3 1) co_x_1_2) (< ts_3 ts_1)))
(assert (=> (and (= rf_3 1) co_x_1_3) (< ts_3 ts_2)))
(assert (=> (and (= rf_3 2) co_x_2_1) (< ts_3 ts_0)))
(assert (=> (and (= rf_3 2) co_x_2_3) (< ts_3 ts_2)))
(assert (=> (and (= rf_3 3) co_x_3_1) (< ts_3 ts_0)))
(assert (=> (and (= rf_3 3) co_x_3_2) (< ts_3 ts_1)))
