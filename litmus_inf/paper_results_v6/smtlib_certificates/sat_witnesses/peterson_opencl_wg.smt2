...
(assert (=> (= rf_2 1) (< ts_4 ts_2)))
(assert (=> (= rf_3 0) (< ts_init_z ts_3)))
(assert (=> (= rf_3 1) (< ts_1 ts_3)))
(assert (=> (= rf_3 2) (< ts_5 ts_3)))
(assert (=> (= rf_6 0) (< ts_init_x ts_6)))
(assert (=> (= rf_6 1) (< ts_0 ts_6)))
(assert (=> (= rf_7 0) (< ts_init_z ts_7)))
(assert (=> (= rf_7 1) (< ts_1 ts_7)))
(assert (=> (= rf_7 2) (< ts_5 ts_7)))
(assert (< ts_init_x ts_0))
(assert (< ts_init_y ts_4))
(assert (< ts_init_z ts_1))
(assert (< ts_init_z ts_5))
(assert (=> co_z_1_2 (< ts_1 ts_5)))
(assert (=> co_z_2_1 (< ts_5 ts_1)))
(assert (=> (= rf_2 0) (< ts_2 ts_4)))
(assert (=> (= rf_3 0) (< ts_3 ts_1)))
(assert (=> (= rf_3 0) (< ts_3 ts_5)))
(assert (=> (and (= rf_3 1) co_z_1_2) (< ts_3 ts_5)))
(assert (=> (and (= rf_3 2) co_z_2_1) (< ts_3 ts_1)))
(assert (=> (= rf_6 0) (< ts_6 ts_0)))
(assert (=> (= rf_7 0) (< ts_7 ts_1)))
(assert (=> (= rf_7 0) (< ts_7 ts_5)))
(assert (=> (and (= rf_7 1) co_z_1_2) (< ts_7 ts_5)))
(assert (=> (and (= rf_7 2) co_z_2_1) (< ts_7 ts_1)))
(assert (and (or (= rf_2 0)) (or (= rf_6 0))))
