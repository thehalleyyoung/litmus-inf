...
(assert (=> (= rf_3 2) (< ts_4 ts_3)))
(assert (=> (= rf_5 0) (< ts_init_y ts_5)))
(assert (=> (= rf_5 1) (< ts_2 ts_5)))
(assert (< ts_init_x ts_1))
(assert (< ts_init_x ts_4))
(assert (=> co_x_1_2 (< ts_1 ts_4)))
(assert (=> co_x_2_1 (< ts_4 ts_1)))
(assert (< ts_init_y ts_2))
(assert (=> (= rf_0 0) (< ts_0 ts_1)))
(assert (=> (= rf_0 0) (< ts_0 ts_4)))
(assert (=> (and (= rf_0 1) co_x_1_2) (< ts_0 ts_4)))
(assert (=> (and (= rf_0 2) co_x_2_1) (< ts_0 ts_1)))
(assert (=> (= rf_3 0) (< ts_3 ts_1)))
(assert (=> (= rf_3 0) (< ts_3 ts_4)))
(assert (=> (and (= rf_3 1) co_x_1_2) (< ts_3 ts_4)))
(assert (=> (and (= rf_3 2) co_x_2_1) (< ts_3 ts_1)))
(assert (=> (= rf_5 0) (< ts_5 ts_2)))
(assert (and (or (= rf_3 1)) (or (= rf_5 0))))
