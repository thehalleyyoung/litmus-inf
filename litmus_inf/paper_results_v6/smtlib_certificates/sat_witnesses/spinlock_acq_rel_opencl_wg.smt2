...
; Pattern: spinlock_acq_rel
; Forbidden outcome: {"r1": 0, "r2": 0}
; ═══════════════════════════════════════════════════════════════════
...
(declare-fun co_y_3_1 () Bool)
(declare-fun co_y_1_3 () Bool)
(declare-fun co_y_3_2 () Bool)
(declare-fun co_y_2_3 () Bool)
...
(assert (or co_y_1_3 co_y_3_1))
(assert (not (and co_y_1_3 co_y_3_1)))
(assert (or co_y_2_3 co_y_3_2))
(assert (not (and co_y_2_3 co_y_3_2)))
(assert (=> (and co_y_1_2 co_y_2_3) co_y_1_3))
(assert (=> (and co_y_1_3 co_y_3_2) co_y_1_2))
(assert (=> (and co_y_2_1 co_y_1_3) co_y_2_3))
(assert (=> (and co_y_2_3 co_y_3_1) co_y_2_1))
(assert (=> (and co_y_3_1 co_y_1_2) co_y_3_2))
(assert (=> (and co_y_3_2 co_y_2_1) co_y_3_1))
(assert (>= ts_0 0))
(assert (< ts_0 90))
(assert (>= ts_1 0))
(assert (< ts_1 90))
...
(assert (=> (= rf_0 1) (< ts_1 ts_0)))
(assert (=> (= rf_0 2) (< ts_3 ts_0)))
(assert (=> (= rf_0 3) (< ts_5 ts_0)))
(assert (=> (= rf_4 0) (< ts_init_y ts_4)))
(assert (=> (= rf_4 1) (< ts_1 ts_4)))
(assert (=> (= rf_4 2) (< ts_3 ts_4)))
(assert (=> (= rf_4 3) (< ts_5 ts_4)))
(assert (=> (= rf_6 0) (< ts_init_x ts_6)))
(assert (=> (= rf_6 1) (< ts_2 ts_6)))
(assert (< ts_init_x ts_2))
(assert (< ts_init_y ts_1))
(assert (< ts_init_y ts_3))
(assert (< ts_init_y ts_5))
(assert (=> co_y_1_2 (< ts_1 ts_3)))
(assert (=> co_y_1_3 (< ts_1 ts_5)))
(assert (=> co_y_2_1 (< ts_3 ts_1)))
(assert (=> co_y_2_3 (< ts_3 ts_5)))
(assert (=> co_y_3_1 (< ts_5 ts_1)))
(assert (=> co_y_3_2 (< ts_5 ts_3)))
(assert (=> (= rf_0 0) (< ts_0 ts_1)))
(assert (=> (= rf_0 0) (< ts_0 ts_3)))
(assert (=> (= rf_0 0) (< ts_0 ts_5)))
(assert (=> (and (= rf_0 1) co_y_1_2) (< ts_0 ts_3)))
(assert (=> (and (= rf_0 1) co_y_1_3) (< ts_0 ts_5)))
(assert (=> (and (= rf_0 2) co_y_2_1) (< ts_0 ts_1)))
(assert (=> (and (= rf_0 2) co_y_2_3) (< ts_0 ts_5)))
(assert (=> (and (= rf_0 3) co_y_3_1) (< ts_0 ts_1)))
(assert (=> (and (= rf_0 3) co_y_3_2) (< ts_0 ts_3)))
(assert (=> (= rf_4 0) (< ts_4 ts_1)))
(assert (=> (= rf_4 0) (< ts_4 ts_3)))
(assert (=> (= rf_4 0) (< ts_4 ts_5)))
(assert (=> (and (= rf_4 1) co_y_1_2) (< ts_4 ts_3)))
(assert (=> (and (= rf_4 1) co_y_1_3) (< ts_4 ts_5)))
(assert (=> (and (= rf_4 2) co_y_2_1) (< ts_4 ts_1)))
(assert (=> (and (= rf_4 2) co_y_2_3) (< ts_4 ts_5)))
(assert (=> (and (= rf_4 3) co_y_3_1) (< ts_4 ts_1)))
(assert (=> (and (= rf_4 3) co_y_3_2) (< ts_4 ts_3)))
(assert (=> (= rf_6 0) (< ts_6 ts_2)))
(assert (and (or (= rf_4 0) (= rf_4 2)) (or (= rf_6 0))))

(check-sat)
(get-model)

; ── SAT Witness (counterexample execution) ──
; Status: SAT — forbidden outcome IS reachable under OpenCL-WG
;   rf_0 = 0
;   rf_4 = 2
;   rf_6 = 0
;   co_y_1_2 = True
