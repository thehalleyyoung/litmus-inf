...
(assert (=> co_y_1_2 (< ts_1 ts_2)))
(assert (=> co_y_2_1 (< ts_2 ts_1)))
(assert (=> (= rf_4 0) (< ts_4 ts_1)))
(assert (=> (= rf_4 0) (< ts_4 ts_2)))
(assert (=> (and (= rf_4 1) co_y_1_2) (< ts_4 ts_2)))
(assert (=> (and (= rf_4 2) co_y_2_1) (< ts_4 ts_1)))
(assert (=> (= rf_5 0) (< ts_5 ts_0)))
(assert (=> (= rf_5 0) (< ts_5 ts_3)))
(assert (=> (and (= rf_5 1) co_x_1_2) (< ts_5 ts_3)))
(assert (=> (and (= rf_5 2) co_x_2_1) (< ts_5 ts_0)))
(assert (and (or (= rf_4 2)) (or (= rf_5 1))))
