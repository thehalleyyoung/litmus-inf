...
(assert (=> (= rf_8 2) (< ts_3 ts_8)))
(assert (< ts_init_x ts_0))
(assert (< ts_init_x ts_3))
(assert (=> co_x_1_2 (< ts_0 ts_3)))
(assert (=> co_x_2_1 (< ts_3 ts_0)))
(assert (< ts_init_y ts_2))
(assert (=> (= rf_5 0) (< ts_5 ts_2)))
(assert (=> (= rf_6 0) (< ts_6 ts_2)))
(assert (=> (= rf_8 0) (< ts_8 ts_0)))
(assert (=> (= rf_8 0) (< ts_8 ts_3)))
(assert (=> (and (= rf_8 1) co_x_1_2) (< ts_8 ts_3)))
(assert (=> (and (= rf_8 2) co_x_2_1) (< ts_8 ts_0)))
(assert (and (or (= rf_6 1)) (or (= rf_8 0))))

(check-sat)

; ── UNSAT Proof Certificate ──
; Status: UNSAT — forbidden outcome UNREACHABLE under Vulkan-WG
; Unsat core size: 5 assertions (out of 50)
; Core assertions: track_forbidden, track_28, track_45, track_34, track_30
(get-unsat-core)
